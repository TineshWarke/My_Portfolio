                ...
                <div className="hero-content text-neutral-content text-center w-full">
                    <div className="w-full">
                        ...
                        <div className='w-fit mb-8 m-auto cursor-none'>
                            <h1 className="font-Sofadi-One mb-5 text-2xl sm:text-4xl font-medium tracking-widest" onMouseEnter={() => setCursorVarient('animatesmall')} onMouseLeave={() => setCursorVarient('default')}>Developer at Work</h1>
                        </div>
